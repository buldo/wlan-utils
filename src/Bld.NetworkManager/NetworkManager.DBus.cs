namespace Bld.NetworkManager
{
    ...
    public partial class AccessPoint : NetworkManagerObject
    {
        ...
        public Task<uint> GetBandwidthAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "Bandwidth"), (Message m, object? s) => ReadMessage_v_u(m, (NetworkManagerObject)s!), this);
    ...
    public record DeviceProperties
    {
        ...
        public NMDeviceType DeviceType { get; set; } = default!;
    ...
    public partial class Device : NetworkManagerObject
    {
        ...
        public async Task<NMDeviceType> GetDeviceTypeAsync()
            => (NMDeviceType)await this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "DeviceType"), (Message m, object? s) => ReadMessage_v_u(m, (NetworkManagerObject)s!), this);
        ...
        private static DeviceProperties ReadProperties(ref Reader reader, List<string>? changedList = null)
        {
            ...
            while (reader.HasNext(arrayEnd))
            {
                ...
                switch (property)
                {
                    ...
                    case "DeviceType":
                        reader.ReadSignature("u"u8);
                        props.DeviceType = (NMDeviceType)reader.ReadUInt32();
    ...
    public partial class WireGuard : NetworkManagerObject
    {
        ...
        public Task<byte[]> GetPublicKeyAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "PublicKey"), (Message m, object? s) => ReadMessage_v_ay(m, (NetworkManagerObject)s!), this);
        public Task<ushort> GetListenPortAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "ListenPort"), (Message m, object? s) => ReadMessage_v_q(m, (NetworkManagerObject)s!), this);
        public Task<uint> GetFwMarkAsync()
            => this.Connection.CallMethodAsync(CreateGetPropertyMessage(__Interface, "FwMark"), (Message m, object? s) => ReadMessage_v_u(m, (NetworkManagerObject)s!), this);
        public Task<WireGuardProperties> GetPropertiesAsync()
        {
            return this.Connection.CallMethodAsync(CreateGetAllPropertiesMessage(__Interface), (Message m, object? s) => ReadMessage(m, (NetworkManagerObject)s!), this);
            static WireGuardProperties ReadMessage(Message message, NetworkManagerObject _)
            {
                var reader = message.GetBodyReader();
                return ReadProperties(ref reader);
            }
        }
        public ValueTask<IDisposable> WatchPropertiesChangedAsync(Action<Exception?, PropertyChanges<WireGuardProperties>> handler, bool emitOnCapturedContext = true, ObserverFlags flags = ObserverFlags.None)
        {
            return base.WatchPropertiesChangedAsync(__Interface, (Message m, object? s) => ReadMessage(m, (NetworkManagerObject)s!), handler, emitOnCapturedContext, flags);
            static PropertyChanges<WireGuardProperties> ReadMessage(Message message, NetworkManagerObject _)
            {
                var reader = message.GetBodyReader();
                reader.ReadString(); // interface
                List<string> changed = new(), invalidated = new();
                return new PropertyChanges<WireGuardProperties>(ReadProperties(ref reader, changed), ReadInvalidated(ref reader), changed.ToArray());
            }
            static string[] ReadInvalidated(ref Reader reader)
            {
                List<string>? invalidated = null;
                ...
                while (reader.HasNext(arrayEnd))
                {
                    ...
                    switch (property)
                    {
                        case "PublicKey": invalidated.Add("PublicKey"); break;
                        case "ListenPort": invalidated.Add("ListenPort"); break;
                        case "FwMark": invalidated.Add("FwMark"); break;
                    }
                }
                return invalidated?.ToArray() ?? Array.Empty<string>();
            }
        }
        private static WireGuardProperties ReadProperties(ref Reader reader, List<string>? changedList = null)
        {
            var props = new WireGuardProperties();
            ArrayEnd arrayEnd = reader.ReadArrayStart(DBusType.Struct);
            while (reader.HasNext(arrayEnd))
            {
                var property = reader.ReadString();
                switch (property)
                {
                    case "PublicKey":
                        reader.ReadSignature("ay"u8);
                        props.PublicKey = reader.ReadArrayOfByte();
                        changedList?.Add("PublicKey");
                        break;
                    case "ListenPort":
                        reader.ReadSignature("q"u8);
                        props.ListenPort = reader.ReadUInt16();
                        changedList?.Add("ListenPort");
                        break;
                    case "FwMark":
                        reader.ReadSignature("u"u8);
                        props.FwMark = reader.ReadUInt32();
                        changedList?.Add("FwMark");
                        break;
                    default:
                        reader.ReadVariantValue();
                        break;
    ...
    public partial class NetworkManagerService
    {
        ...
        public WireGuard CreateWireGuard(ObjectPath path) => new WireGuard(this, path);
    ...
    public class NetworkManagerObject
    {
        ...
        protected static ushort ReadMessage_v_q(Message message, NetworkManagerObject _)
        {
            var reader = message.GetBodyReader();
            reader.ReadSignature("q"u8);
